package com.github.captcha.base;
...
public abstract class Captcha extends Randoms {
    ...
    // 验证码文本类型
    private static final int TYPE_DEFAULT = 1;  // 字母数字混合
    ...
    public void setFont(int font, int style, float size) throws IOException, FontFormatException {
        this.font = Font.createFont(Font.TRUETYPE_FONT, getClass().getResourceAsStream("/font/" + FONT_NAMES[font])).deriveFont(style, size);
    }
